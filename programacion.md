...
Hay tres manera de programar el Sumobot, una es con una interfáz de bloques, una interfaz web que no requiere instalación, y otra es directamente en Python también a través del browser
