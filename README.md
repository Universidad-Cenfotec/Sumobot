...
Tenemos una nueva versión del chasis del Sumobot que no ocupa pegamento. Se une con tiras de plástico, lo cual facilita su construcción y reparación. Eñ Archivo [SumoBot_Sin_Goma.svg](https://github.com/Universidad-Cenfotec/Sumobot/blob/main/archivos_de_fabricacion/SumoBot_Chasis.svg) contiene el diseño para corte láser.
